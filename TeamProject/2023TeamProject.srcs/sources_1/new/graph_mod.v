...
assign rgb = (font_bit & red_on)?        RGB_RED : //RED text_RED
             ...
             (broom_on_center[0])?         RGB_OCHER: //브룸
             (broom_on_center[1])?         RGB_OCHER: //브룸
             (broom_on_center[2])?         RGB_OCHER: //브룸
             (broom_on_center[3])?         RGB_OCHER: //브룸
             (broom_on_center[4])?         RGB_OCHER: //브룸
             (broom_on_center[5])?         RGB_OCHER: //브룸
             
             (broom_on_up[0])?         RGB_OCHER: //브룸
             (broom_on_up[1])?         RGB_OCHER: //브룸
             (broom_on_up[2])?         RGB_OCHER: //브룸
             (broom_on_up[3])?         RGB_OCHER: //브룸
             (broom_on_up[4])?         RGB_OCHER: //브룸
             (broom_on_up[5])?         RGB_OCHER: //브룸
             
             (broom_on_left[0])?         RGB_OCHER: //브룸
             (broom_on_left[1])?         RGB_OCHER: //브룸
             (broom_on_left[2])?         RGB_OCHER: //브룸
             (broom_on_left[3])?         RGB_OCHER: //브룸
             (broom_on_left[4])?         RGB_OCHER: //브룸
             (broom_on_left[5])?         RGB_OCHER: //브룸
             
             (broom_on_right[0])?         RGB_OCHER: //브룸
             (broom_on_right[1])?         RGB_OCHER: //브룸
             (broom_on_right[2])?         RGB_OCHER: //브룸
             (broom_on_right[3])?         RGB_OCHER: //브룸
             (broom_on_right[4])?         RGB_OCHER: //브룸
             (broom_on_right[5])?         RGB_OCHER: //브룸
